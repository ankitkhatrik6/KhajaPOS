...
[![Debian](https://img.shields.io/badge/Package-.deb-2ea043)](khajapos_2.2.1-1_all.deb)
[![Version](https://img.shields.io/badge/Version-2.2.1-7c3aed)](khajapos_2.2.1-1_all.deb)
...
| ---- | ---- | ----------- |
| [`khajapos_2.2.1-1_all.deb`](khajapos_2.2.1-1_all.deb) | ~30 MB | Debian / Ubuntu package (64-bit, all architectures) |
...
(`khajapos_2.2.1-1_all.deb` or newer).
