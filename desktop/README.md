...
[![Debian](https://img.shields.io/badge/Package-.deb-2ea043?style=flat-square&logo=debian&logoColor=white)](khajapos_2.2.4-1_all.deb)
[![Version](https://img.shields.io/badge/Version-2.2.4-7c3aed?style=flat-square)](khajapos_2.2.4-1_all.deb)
...
```bash
ls -lh ~/Downloads/khajapos_2.2.4-1_all.deb
```

Optional checksum verification:

```bash
sha256sum ~/Downloads/khajapos_2.2.4-1_all.deb
```
